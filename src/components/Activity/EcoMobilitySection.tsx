            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => navigate(`/itineraire?type=bus&destination=${encodeURIComponent(activityAddress || '')}`)}
                  className="mt-2"
                >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => navigate(`/itineraire?type=bike&destination=${encodeURIComponent(activityAddress || '')}`)}
                  className="mt-2"
                >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => navigate(`/itineraire?type=walk&destination=${encodeURIComponent(activityAddress || '')}`)}
                  className="mt-2"
                >
