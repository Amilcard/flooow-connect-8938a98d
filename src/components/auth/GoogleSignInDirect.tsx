...
// Google Client ID from GCP Console
const GOOGLE_CLIENT_ID = '635641228660-0kcbrkatmemm76i3t6n9lvimbi712rv5.apps.googleusercontent.com';
    ...
    if (window.google) {
      window.google.accounts.id.prompt((notification) => {
        if (notification.isNotDisplayed()) {
          ...
          // Fallback: show popup
          toast.info('Popup Google bloqué. Autorisez les popups pour ce site.');
        }
      ...
      toast.error('Google Sign-In non chargé. Rechargez la page.');
    }
  };
