 ...
 *
 * Note: Cette version utilise signInWithOAuth standard car signInWithIdToken
 * nécessite une configuration backend complexe.
 *
 * Pour afficher "Inklusif Flooow" au lieu du domaine Supabase:
 * - Compléter la validation branding dans Google Cloud Console
...
export function GoogleSignInDirect({
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // La redirection va se produire automatiquement
    } catch (err) {
