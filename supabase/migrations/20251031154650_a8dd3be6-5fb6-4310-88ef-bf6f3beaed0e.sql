-- Fix: Normaliser les catégories en minuscules pour le matching d'aides financières
...
RETURNS TABLE(aid_name text, amount numeric, territory_level text, official_link text)
LANGUAGE plpgsql
SECURITY DEFINER
